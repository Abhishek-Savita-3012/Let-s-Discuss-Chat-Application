//This site is different than nodeServer, we are connecting this site to that site
...
//If a new user jouns, receive his/her name from the server
...
form.addEventListener('submit', (e)=>{
    e.preventDefault();    //helps in preventing reload of page
